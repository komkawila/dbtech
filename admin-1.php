...
<body>
    ...
    <div class="row align-items-start">
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="row align-items-center">
                            <label for="exampleInputEmail1" class="form-label bi bi-people">
                                <img src="assets/file-earmark-text.svg" alt="" width="50" height="50" class="navbar-brand mx-auto" />
                                ข้อมูลโครงงาน
                            ...
                            <div class="col-2 ">
                                ...
                                <select class="form-select" name="class">
                                    ...
                                    <option value="ปวช">ปวช.3</option>
                                    <option value="ปวส">ปวส.2</option>
                                </select>
                            </div>
                            <div class="col-2 ">
                            ...
                            <div class=" col-3 ">
                                <div id=" emailHelp" class="form-text">เพิ่มข้อมูลโครงงาน
                            </div>
                            <!-- <br /> -->
                            <a href="admin-addproject.php" class="btn btn-success">เพิ่มข้อมูลโครงงาน</a>
                        </div>
                    </div>
                </div>
        </div>
                    ...
                    <tbody>
                        ...
                        if (!empty($_GET['searchmsg']) && !empty($_GET['class']) && !empty($_GET['year'])) {  // invalue
                            ...
                            while ($rows[] = mysqli_fetch_array($query_2)) {
                                ...
                                echo '<td> <a type="button" class="btn btn-warning btn-sm" href="admin-editproject.php?id=' . $rows[$conunt]['project_id'] . '">แก้ไข</a> <a type="button" href="javascript:openulr(' . $rows[$conunt]['project_id'] . ');" class="btn btn-danger btn-sm">ลบ</a> </td>';
                                echo '</tr>';
                                $conunt++;
                            }
                        } else { // emtry
        ...
        <?php
        if (!empty($_GET['searchmsg']) && !empty($_GET['class']) && !empty($_GET['year'])) {  // invalue
            echo '<a href=" index.php" class="btn btn-light"><img src="assets/box-arrow-left.svg" class="navbar-brand mx-auto" /></a>';
        }
        ?>
