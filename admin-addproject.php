...
<body>
    ...
    <div class="row align-items-start">
        ...
        <div class="col-8 ">
            <form action="addproject_db.php" method="post">
                <div class="">
                    <div class="d-flex justify-content-center">
                        <div class="row align-items-center">
                            ...
                            <div class="row ">
                                ...
                                <input type="text" class="form-control" name="projectname" placeholder="กรุณากรอกหัวข้อโครงงาน"></input>
                            </div>
                            <div class="row ">
                            ...
                            <div class="row ">
                                ...
                                <input type="text" class="form-control" name="url" placeholder="กรุณากรอกลิ้งค์ URL"></input>
                            </div>
                            <div class="row">
                                <br />
